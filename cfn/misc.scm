...
(define-walker-method cfn dtype-placeholder (object)
  (if (eq? (dtype-placeholder-exp object) '#f)
      (error "Type checker screwed a dtype placeholder object ~s." object)
      (cfn-ast-1 (dtype-placeholder-exp object))))
